...
{
  if (is.null(data)) test = simnew(mean.s,mean.t,sigma0 = 1,sigma=1,rho = .5, tau1 = 1, tau2 = 1,treat,covValues,data=NULL,inspection) else simold(mean.s,mean.t,sigma0 = 1,sigma=1,rho = .5, tau1 = 1, tau2 = 1,treat,covValues,data,inspection)
...
#' @param data Is the data from the previous analysis if applicable. The default is NULL
#' @export
simnew = function(mean.s,mean.t,sigma0 = 1,sigma=1,rho = .5, tau1 = 1, tau2 = 1,treat,covValues,data= NULL,inspection) {
  prop = trialprogress[inspection]
  trts = unique(treat)
  trts = trts[order(trts)]
...
#' @param data Is the data from the previous analysis if applicable. The default is NULL
#' @export
simold = function(mean.s,mean.t,sigma0 = 1,sigma=1,rho = .5, tau1 = 1, tau2 = 1,treat,covValues,data,inspection) {
  prop = trialprogress[inspection]
  trts = unique(treat)
  trts = trts[order(trts)]
